...
/**
 * Write a description of class RocketB here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class RocketB extends Projectiles
{
    private Actor initActor;
    boolean initLoc = false;
    private int actCount = 0;
    public RocketB(double initx, double inity, double toX, double toY, Actor originalActor){
    ...
    public void act(){
        ...
        if(getWorld() instanceof Editor){
            ...
            m.addObject(new RocketTrail(x, y),0,0);

            moveProjectile();
            Actor collidedObj = checkHit();
            if(collidedObj != null && collidedObj != initActor && collidedObj.getClass() != Gun.class  && collidedObj.getClass() != RocketB.class){
